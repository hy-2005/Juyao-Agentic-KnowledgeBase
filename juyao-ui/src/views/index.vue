  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>juyao-agentic-rag 系统</h2>
        <p>
          面向企业知识库的 Agentic RAG + GraphRAG 管理平台，支持混合检索、意图路由、图谱增强、流式对话与异步入库。提供知识图谱可视化、切片管理、文档入库与智能问答等管理能力。
        </p>
        <p>
        ...
        <p>
          <el-button
            ...
            icon="el-icon-cloudy"
            plain
            @click="goTarget('https://gitee.com/y_project/Juyao-Vue')"
            >访问码云</el-button
          >
          <el-button
            size="mini"
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-promotion"></i> 官网：<el-link
                href="http://www.juyao.vip"
                target="_blank"
                >http://www.juyao.vip</el-link
              >
            </p>
            <p>
            ...
            <p>
              <i class="el-icon-document"></i> 说明：JuYao Agentic RAG 开源知识库与图谱增强检索方案
            </p>
          </div>
        </el-card>
      </el-col>
        ...
        <el-card class="update-log">
          ...
          <el-collapse accordion>
            ...
            <el-collapse-item title="v1.0.0 - 2019-10-08">
              <ol>
                <li>juyao-agentic-rag 系统正式发布</li>
              </ol>
            </el-collapse-item>
          </el-collapse>
        </el-card>
