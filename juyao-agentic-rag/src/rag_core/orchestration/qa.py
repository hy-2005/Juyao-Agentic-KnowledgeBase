...
from rag_core.orchestration.constants import DISCLAIMER, DISCLAIMER_NO_KB_REFERENCES, NO_KB_STREAM_PREFIX
...
def answer_question(question: str) -> QAResult:
    ...
    prefix = "" if has_evidence else NO_KB_STREAM_PREFIX
